...
const AmplificadoresModificar = () => {
  ...
  const traerAmplificador = (cl) => {
    axios
      .get(`http://localhost:5000/amplificador/traer/${cl}`)
      .then(function (response) {
        // handle success
        // console.log(response);
        const conteo = response.data.length;
        if(conteo>0) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios
      .post("http://localhost:5000/amplificador/modificar", ampli)
      .then(function (response) {
        // handle success
        // console.log(response);
      ...
      <Row>
        ...
        <Col>
          <Form onSubmit={handleSubmit}>
            ...
            <Button className="ms-3" variant="secondary" onClick={handleCancelar}>
              Cancelar
            </Button>
          </Form>
        </Col>
...
export default AmplificadoresModificar;